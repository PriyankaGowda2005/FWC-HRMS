...
const createComprehensiveHRSeedData = async () => {
  try {
    console.log('🌱 Creating Comprehensive HR Seed Data with All Modules...');
    ...
    console.log('🏢 Creating comprehensive departments...');
    const departments = [
      {
    ...
    // Create comprehensive employees
    console.log('👥 Creating comprehensive employees...');
    const employees = [
      // IT Department
      {
        userId: new ObjectId(),
    ...
    // Final summary
    console.log('\n🎉 Comprehensive HR Seed Data Created Successfully!');
    ...
    console.error('❌ Error creating comprehensive HR seed data:', error);
    throw error;
  } finally {
...
if (require.main === module) {
  createComprehensiveHRSeedData()
    .then(() => {
      console.log('✅ Comprehensive HR seed data creation completed');
      process.exit(0);
    })
    .catch((error) => {
      console.error('❌ Comprehensive HR seed data creation failed:', error);
      process.exit(1);
    });
}

module.exports = { createComprehensiveHRSeedData };
