...
const EmployeeDashboard = () => {
  ...
  const { data: leaveData, isLoading: leaveLoading, error: leaveError, refetch: refetchLeave } = useQuery(
  ...
  const { data: payrollData, isLoading: payrollLoading, error: payrollError, refetch: refetchPayroll } = useQuery(
